...
from entidades.sensor_humedad import SensorHumedad
from entidades.sensor_temperatura import SensorTemperatura

# === IMPORTS DE SERVICIOS ===
from servicios.dispositivos_service import DispositivoService
from servicios.sensor_service import SensorService
from servicios.usuario_service import UsuarioService
from servicios.automatizacion_service import AutomatizacionService, ReglaAutomatica
from servicios.registro_domotico_service import RegistroDomoticoService

# === IMPORTS DE EXCEPCIONES ===
from excepciones.domotica_excepcion import DomoticaException
...
try:
    # ------------------------------------------------------------------
    # 1️⃣ INICIALIZACIÓN DE USUARIO Y SERVICIOS
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 2️⃣ CREACIÓN DE DISPOSITIVOS DESDE CONFIGURACIÓN
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 3️⃣ DEMOSTRACIÓN DE LECTURA DE SENSORES
    # ------------------------------------------------------------------
    print("\n--- Lectura de Sensores ---")
    ...
    # ------------------------------------------------------------------
    # 4️⃣ DEMOSTRACIÓN DE AUTOMATIZACIONES (PATRÓN OBSERVER)
    # ------------------------------------------------------------------
    print("\n--- Reglas Automáticas ---")
    ...
    # ------------------------------------------------------------------
    # 5️⃣ GUARDAR ESTADO DEL SISTEMA
    # ------------------------------------------------------------------
